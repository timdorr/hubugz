...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'colony.User';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Password', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'password', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::PASSWORD, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'PASSWORD', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'password', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Password' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'password' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::PASSWORD => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'PASSWORD' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'password' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

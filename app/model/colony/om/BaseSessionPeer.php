...
abstract class BaseSessionPeer {
	...
	const CLASS_DEFAULT = 'colony.Session';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Data', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'data', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATA, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATA', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'data', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Data' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'data' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATA => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATA' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'data' => 1, 'created_at' => 2, 'updated_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SessionPeer::CREATED_AT);
			$criteria->addSelectColumn(SessionPeer::UPDATED_AT);
		} else {
